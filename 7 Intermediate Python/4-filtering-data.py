...
def run():
    ...
    old_peope = list( map( lambda worker: worker | {"old": worker["age"] > 70 }, DATA ) )
    
    
    
    
    
    print(all_python_devs == all_python_devs2)
    print(all_platzi_workers == all_platzi_workers2)
    
    
    for adult in old_peope:
        print(adult)
